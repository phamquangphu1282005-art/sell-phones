                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            <h2 style="font-size: 28px;" >Chào mừng bạn đã đến với PTHA MOBILE </h2>
                            <p>Hãy đăng ký tài khoản để có trải nghiệm tốt nhất</p>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3 style=" font-size: 22px;">Chào Mừng Bạn Đã Quay Trở Lại <br> Đăng Nhập Ngay Tại Đây</h3>
                            <?php
